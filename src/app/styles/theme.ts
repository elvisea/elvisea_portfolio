...
export const sectionStyles = {
  ...
  secondary:
    "min-h-screen flex items-center py-24 bg-gray-50 dark:bg-gray-900/50",
  gradient:
    "min-h-screen flex items-center py-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800",
};
...
export const sectionHeader = {
  ...
  badge:
    "inline-block mb-3 px-4 py-1 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-300 text-sm font-medium",
...
export const cardStyles = {
  default:
    "bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-shadow",
  bordered:
    "bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl shadow-sm hover:shadow-md transition-shadow",
};
