...
export const content = {
  ...
  hero: {
    ...
    subtitle:
      "Desenvolvimento de software personalizado para empresas que buscam inovação, qualidade e resultados.",
    ...
    items: [
      {
        ...
        description:
          "Criamos aplicações web responsivas, rápidas e escaláveis utilizando as tecnologias mais modernas do mercado.",
        Icon: Code,
        features: [
      ...
      },
      {
        ...
        description:
          "Desenvolvemos aplicativos mobile intuitivos e de alta performance para iOS e Android.",
        Icon: Smartphone,
        features: [
      ...
      },
      {
        ...
        description:
          "Projetamos interfaces que proporcionam a melhor experiência para seus usuários, com foco em usabilidade e conversão.",
        Icon: PenTool,
        features: [
      ...
      },
      {
        ...
        description:
          "Oferecemos consultoria técnica para ajudar sua empresa a tomar as melhores decisões tecnológicas.",
        Icon: Search,
        features: [
      ...
      },
      {
        ...
        description:
          "Desenvolvemos e integramos APIs para conectar diferentes sistemas e serviços, criando um ecossistema digital coeso.",
        Icon: Layers,
        features: [
      ...
      },
      {
        ...
        description:
          "Analisamos e otimizamos a performance de aplicações existentes, melhorando a experiência do usuário e reduzindo custos.",
        Icon: Zap,
        features: [
  ...
  process: {
    ...
    subtitle:
      "Uma abordagem estruturada para transformar sua visão em realidade digital.",
    steps: [
      {
        title: "Descoberta e Planejamento",
        subtitle: "Entendendo suas necessidades",
        description:
          "Iniciamos com uma análise profunda dos requisitos do projeto, objetivos de negócio e necessidades dos usuários para criar um plano de ação detalhado.",
        Icon: Search,
      },
      {
        ...
        description:
          "Criamos wireframes e protótipos interativos que permitem visualizar e validar a solução antes do desenvolvimento, economizando tempo e recursos.",
        Icon: PenTool,
      },
      {
        ...
        description:
          "Utilizamos metodologias ágeis para desenvolver seu produto em ciclos curtos, permitindo ajustes e melhorias contínuas ao longo do processo.",
        Icon: Code,
      },
      {
        ...
        description:
          "Realizamos testes rigorosos de funcionalidade, usabilidade, segurança e performance para garantir um produto final de alta qualidade.",
        Icon: CheckCircle,
      },
      {
        title: "Lançamento",
        ...
        description:
          "Preparamos e executamos o lançamento do seu produto, garantindo uma transição suave para o ambiente de produção e uma experiência positiva para os usuários.",
        Icon: Rocket,
      },
      {
        ...
        description:
          "Oferecemos suporte técnico, manutenção e atualizações contínuas para garantir que seu produto digital evolua e se mantenha relevante ao longo do tempo.",
        Icon: RefreshCw,
      },
    ] as ProcessStep[],
  },
    ...
    projects: [
      {
        ...
        description:
          "Desenvolvimento completo de uma plataforma de e-commerce com integração de pagamentos, gestão de estoque e painel administrativo personalizado.",
      ...
      },
      {
        ...
        description:
          "Aplicativo mobile para iOS e Android para serviço de delivery com rastreamento em tempo real, pagamentos in-app e sistema de avaliações.",
      ...
      },
      {
        ...
        description:
          "Sistema web completo para gestão de recursos humanos, financeiro, projetos e clientes com dashboards personalizados e relatórios avançados.",
        ...
        results: [
          ...
          "Centralização de dados em uma única plataforma",
  ...
  testimonials: {
    ...
    subtitle:
      "Conheça as experiências de quem já transformou suas ideias em realidade com a BytefulCode.",
    items: [
      {
        name: "Ana Silva",
        role: "CEO",
  ...
  team: {
    title: "Nossa Equipe",
    subtitle:
      "Conheça os especialistas por trás dos nossos projetos de sucesso",
    members: [
      {
        name: "Rafael Mendes",
        role: "CTO & Fundador",
        ...
        description:
          "Com mais de 10 anos de experiência em desenvolvimento de software, Rafael lidera nossa equipe técnica com foco em inovação e excelência.",
        specialties: [
      ...
      },
      {
        ...
        description:
          "Especialista em design centrado no usuário, Camila transforma requisitos complexos em interfaces intuitivas e visualmente atraentes.",
        specialties: [
      ...
      },
      {
        ...
        description:
          "Desenvolvedor versátil com profundo conhecimento em tecnologias frontend e backend, Lucas é especialista em criar soluções robustas e escaláveis.",
    ...
    items: [
      {
        ...
        answer:
          "O tempo de desenvolvimento varia conforme a complexidade do projeto. Um MVP pode levar de 2 a 3 meses, enquanto aplicações mais complexas podem levar 4 a 6 meses ou mais. Durante a fase de descoberta, fornecemos um cronograma detalhado específico para o seu projeto.",
      },
      {
        question: "Quais tecnologias vocês utilizam?",
        answer:
          "Trabalhamos com um amplo conjunto de tecnologias modernas, incluindo React, React Native, Node.js, Next.js, TypeScript, Python, e diversas soluções de banco de dados. Escolhemos a stack tecnológica mais adequada para cada projeto, considerando requisitos específicos, escalabilidade e manutenção a longo prazo.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Sim, oferecemos diversos planos de suporte e manutenção pós-lançamento. Estes incluem correção de bugs, atualizações de segurança, melhorias de performance e implementação de novos recursos. Podemos personalizar um plano de suporte que atenda às necessidades específicas do seu negócio.",
      },
      {
        question: "É possível fazer modificações durante o desenvolvimento?",
        answer:
          "Sim, nossa metodologia ágil permite flexibilidade para ajustes durante o desenvolvimento. Trabalhamos em ciclos curtos (sprints) e realizamos revisões regulares, permitindo que você forneça feedback e solicite ajustes ao longo do processo. Mudanças significativas no escopo podem impactar prazos e custos, mas sempre discutimos isso transparentemente.",
      },
      {
        question: "Vocês assinam acordos de confidencialidade (NDA)?",
        answer:
          "Absolutamente. Respeitamos a confidencialidade de suas ideias e informações. Estamos sempre dispostos a assinar acordos de não divulgação (NDAs) antes de discutir detalhes do seu projeto. A confiança e a segurança das informações são fundamentais em nosso relacionamento com os clientes.",
      },
    ] as FAQItem[],
  },
  ...
  contact: {
    ...
    subtitle:
      "Estamos prontos para transformar sua ideia em realidade. Preencha o formulário abaixo e iniciaremos uma conversa.",
    formCta: {
  ...
  footer: {
    about: {
      ...
      description:
        "Somos uma software house especializada em desenvolvimento de aplicações web e mobile de alta qualidade. Nossa missão é transformar ideias em soluções digitais inovadoras que impulsionam o sucesso dos nossos clientes.",
    },
    contact: {
      title: "Contato",
      email: EMAIL_CONTACT,
